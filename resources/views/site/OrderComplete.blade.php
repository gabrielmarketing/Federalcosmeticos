                ...
                <div class="col-lg-8">
                    <ul class="breadcrumb breadcrumb-dividers-no-opacity font-weight-bold text-6 justify-content-center my-5">
                        ...
                        <li class="text-transform-none text-color-dark me-2">
                            <a href="{{route("site.Checkout")}}" class="text-decoration-none text-color-dark text-color-hover-primary">Checkout</a>
                        </li>
                        <li class="text-transform-none text-color-dark">
                            <a href="{{route("site.OrderComplete")}}" class="text-decoration-none text-color-primary">Pedido Finalizado</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-lg-8">
                    <div class="card border-width-3 border-radius-0 border-color-success">
                        <div class="card-body text-center">
                            <p class="text-color-dark font-weight-bold text-4-5 mb-0"><i class="fas fa-check text-color-success me-1"></i> Obrigado. Seu pedido foi recebido.</p>
                        </div>
                    </div>
                    <div class="d-flex flex-column flex-md-row justify-content-between py-3 px-4 my-4">
                        ...
                        <div class="text-center mt-4 mt-md-0">
									<span>
										Total <br>
										<strong class="text-color-dark">R$10</strong>
									</span>
                        </div>
                        <div class="text-center mt-4 mt-md-0">
									<span>
										Método de pagamento <br>
										<strong class="text-color-dark">Boleto</strong>
									</span>
                        </div>
                    </div>
                    <div class="card border-width-3 border-radius-0 border-color-hover-dark mb-4">
                        <div class="card-body">
                            ...
                            <table class="shop_table cart-totals mb-0">
                                ...
                                <tr class="shipping">
                                    <td class="border-top-0">
                                        <strong class="text-color-dark">Envio</strong>
                                    </td>
                                    <td class="border-top-0 text-end">
                                        <strong><span class="amount font-weight-medium">Envio Grátis</span></strong>
                                    </td>
                                </tr>
                                <tr class="total">
                                    <td>
                    ...
                    <div class="row pt-3">
                        <div class="col-lg-6 mb-4 mb-lg-0">
                            <h2 class="text-color-dark font-weight-bold text-5-5 mb-1">Endereço de Cobrança</h2>
                            <ul class="list list-unstyled text-2 mb-0">
                                <li class="mb-0">Walisson Sidney</li>
                        ...
                        <div class="col-lg-6">
                            <h2 class="text-color-dark font-weight-bold text-5-5 mb-1">Endereço para envio</h2>
                            <ul class="list list-unstyled text-2 mb-0">
