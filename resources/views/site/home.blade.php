                ...
                <div class="col-lg-5 mb-5">
                    ...
                    <p>
                        <a href="https://getbootstrap.com/" target="_blank">
                            <img src="{{asset("porto/img/bs5-updated.png")}}" class="img-fluid mt-2" alt="Bootstrap 5" width="200">
                        </a>
                    </p>
    ...
    <section class="section section-no-border pb-0 m-0">
        <div class="container">
            ...
            <div class="image-wrapper position-relative z-index-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500" data-appear-animation-duration="750" style="height: 0; padding-bottom: 16%;">
                <img src="{{asset("porto/img/lazy.png")}}" data-src="{{asset("porto/img/landing/theme_options.png")}}" class="lazyload img-fluid" alt="The Most Customizable Template">
            </div>
        </div>
    </section>

    <section class="section section-no-border section-angled section-dark pb-0 m-0" style="background-repeat: no-repeat; background-color: #0169fe !important;" data-src="{{asset("porto/img/landing/reason_bg.png")}}">
            ...
            <div class="row align-items-center pt-md-5 mt-5">
                <div class="col-lg-6 offset-lg-1 position-relative mb-5">
                    <div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="500">
                        <img src="{{asset("porto/img/lazy.png")}}" data-src="{{asset("porto/img/landing/porto_dots.png")}}" width="154" height="146" class="lazyload position-absolute top-auto" alt="6 reasons" data-plugin-float-element data-plugin-options="{'startPos': 'none', 'speed': 3, 'transition': true}" style="bottom: 184px; left: 70px;">
                    </div>
                ...
                <div class="col-lg-11">
                    <div class="row justify-content-center">
                        <div class="col-10 col-sm-6 col-lg-4 image-box appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600" data-appear-animation-duration="750">
                            <img class="lazyload img-fluid" alt="Speed Performance" src="{{asset("porto/img/lazy.png")}}" data-src="{{asset("porto/img/landing/reason1.png")}}">
                        ...
                        <div class="col-10 col-sm-6 col-lg-4 image-box appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800" data-appear-animation-duration="750">
                            <img class="lazyload img-fluid" alt="Solid and tested base" src="{{asset("porto/img/lazy.png")}}" data-src="{{asset("porto/img/landing/reason2.png")}}">
                            <div class="d-flex align-items-center mb-2">
                        ...
                        <div class="col-10 col-sm-6 col-lg-4 image-box appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1000" data-appear-animation-duration="750">
                            <img class="lazyload img-fluid" alt="Top designs created by usability specialists" src="{{asset("porto/img/lazy.png")}}" data-src="{{asset("porto/img/landing/reason3.png")}}">
                            <div class="d-flex align-items-center mb-2">
                        ...
                        <div class="col-10 col-sm-6 col-lg-4 image-box appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300" data-appear-animation-duration="750">
                            <img class="lazyload img-fluid" alt="The best customer experience" src="{{asset("porto/img/lazy.png")}}" data-src="{{asset("porto/img/landing/reason4.png")}}">
                            <div class="d-flex align-items-center mb-2">
                        ...
                        <div class="col-10 col-sm-6 col-lg-4 image-box appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500" data-appear-animation-duration="750">
                            <img class="lazyload img-fluid" alt="Works perfectly with Porto Admin Template" src="{{asset("porto/img/lazy.png")}}" data-src="{{asset("porto/img/landing/reason5.png")}}">
                            <div class="d-flex align-items-center mb-2">
                        ...
                        <div class="col-10 col-sm-6 col-lg-4 image-box appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="700" data-appear-animation-duration="750">
                            <img class="lazyload img-fluid" alt="Always keep template updates" src="{{asset("porto/img/lazy.png")}}" data-src="{{asset("porto/img/landing/reason6.png")}}">
                            <div class="d-flex align-items-center mb-2">
        ...
        <div class="container py-5 mt-5">
            <div class="row align-items-center mt-4 pt-2">
                <div class="col-lg-6 pe-lg-5 position-relative text-center mb-5 mb-lg-0">
                    <img alt="Porto Headers" src="{{asset("porto/img/lazy.png")}}" data-src="{{asset("porto/img/landing/porto_headers.png")}}" class="img-fluid lazyload appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="300" />
                </div>
        ...
        <div class="container pb-5 mb-5">
            <div class="row align-items-center mb-5">
                ...
                <div class="col-lg-4 offset-lg-2 position-relative">
                    <div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="500">
                        <img class="img-fluid lazyload" src="{{asset("porto/img/lazy.png")}}" data-src="{{asset("porto/img/landing/porto_dots2.png")}}" alt="" style="position: absolute; bottom: -2%; left: -43%; transform: rotate(90deg)">
                    </div>
                    <img alt="Porto Support" src="{{asset("porto/img/lazy.png")}}" data-src="{{asset("porto/img/landing/support_login.jpg")}}" class="img-fluid border border-width-10 border-color-light rounded box-shadow-3 lazyload ms-5 appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="200" style="width: 590px; max-width: none;">
                    <img alt="Porto Documentation" src="{{asset("porto/img/lazy.png")}}" data-src="{{asset("porto/img/landing/porto_docs.jpg")}}" class="img-fluid lazyload rounded box-shadow-3 position-absolute appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="700" style="left: -100px; bottom: 50px;">
                </div>
            </div>
        </div>
